...
const CONFLICT = "Ошибка: 409";

module.exports = {API_MOVIE_URL, API_MY_URL, EMAIL_REXP, NAME_REXP, VALIDATION, SCREEN_LG, SCREEN_MD, IN_MOVIE_LG, IN_MOVIE_MD, IN_MOVIE_SM, ADD_MOVIE_LG, ADD_MOVIE_MD, ADD_MOVIE_SM, DUR_SHORT_FILM, CONFLICT };
